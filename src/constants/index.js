...
export const resumeLink =
  "https://drive.google.com/file/d/19n9x9SLn8Lx1CpmeyRO4ntsfENNfmzJq/view?usp=sharing";
export const repoLink = "https://github.com/Rakeshivam";

export const callToAction = "https://www.linkedin.com/in/er-rakesh-kushwaha/";
...
export const educationList = [
  {
    id: "education-1",
    icon: nitk,
    title: "Dr. Rammanohar Lohia Avadh University (Ayodhya)",
    degree: "Bachelor of Technology",
    duration: "2021 - 2025",
    content1: "Department: Information Technology",
...
export const achievements = [
  {
    ...
    article:
      "https://www.linkedin.com/in/er-rakesh-kushwaha/",
    project: "https://github.com/Rakeshivam",
    // youtube:
...
export const projects = [
  ...
  // },
  {
    ...
    link: "https://www.linkedin.com/in/er-rakesh-kushwaha/",
    image: portfolio,
    content: "Open source developer portfolio template with modern UI/UX. So many stars on GitHub.",
    stack: [
      {
        id: "icon-1",
        icon: SiReact,
...
export const extraCurricular = [
  ...
  {
    id: 2,
    organisation: "Google Developer Student Club, IET (RMLAU)",
    // title: "Co-Chair",
    duration: "March 2022 - Present",
    content: [
      {
        text: "Started HackClub to promote and spread the culture of Hackathons in the college.",
        link: "",
      },
      // {
  ...
  },
  {
    ...
    content: [
      ...
      {
        text: "Lead volunteers and ground staff for diya lighting, crowd management, and cleanliness.",
        link: "",
      },
      {
        text: "Assign duties to specific team members and ensure task completion.",
        link: "",
      },
      {
        text: "Track progress of diya-lighting counts and relay updates for record attempts.",
        link: "",
      },
    ],
    logo: genesis,
...
export const socialMedia = [
  ...
  },
  {
    id: "social-media-3",
    icon: AiFillMail,
    link: "mailto:rakeshkk589@gmail.com",
  },
  {
    id: "social-media-4",
  ...
  },
  {
    ...
    link: "https://www.instagram.com/_rakeshivam_/?hl=en",
  },
];
...
export const aboutMe = {
  ...
  githubUsername: "Rakeshivam",
  tagLine:
    "Python | JavaScript | MERN Stack Developer | Open Source Enthusiast",
  intro:
